...
const checkOverlap = (firstStartSection:number, firstEndSection:number,secondStartSection:number, secondEndSection:number) : boolean =>{
            ...
            if((secondStartSection >= firstStartSection) && (secondStartSection <= firstEndSection)) return true;
            if((firstStartSection >= secondStartSection) && (firstStartSection <= secondEndSection)) return true;
